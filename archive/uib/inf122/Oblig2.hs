--Simen Fuglestad
-- s 2 3 b 3 3 n 15 4 6 6 5 5 6 5 5 5 4 2 5 2 4 3 5 3 4 4 4 4 3 3 3 
import System.IO;
import Data.Char;
...
formatInfo s b n cells = "s " ++ show (fst s) ++ " " ++ show (snd s) ++
    " b " ++ show (fst b) ++ " " ++  show(snd b) ++ " n " ++ show n ++ " " ++ cellsToString cells
